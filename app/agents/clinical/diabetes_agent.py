"""
Diabetes Agent — RAG-powered (clinical)
Answers diabetes-related questions using the 'diabetes_knowledge' Qdrant collection.
...
class DiabetesAgent:
    ...
    async def _retrieve_context(self, query: str, top_k: int = 5) -> list[str]:
        """Embed query and retrieve relevant chunks from the diabetes Qdrant collection."""
