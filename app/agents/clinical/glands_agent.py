"""
Glands Agent — RAG-powered (clinical)
Answers thyroid/endocrine questions using the 'glands_knowledge' Qdrant collection.
...
class GlandsAgent:
    name = "glands_agent"
    collection = "glands_knowledge"
    display_name = "Endocrine / Thyroid"
    specialty = "Endocrine & Thyroid (Glands)"

    async def _retrieve_context(self, query: str, top_k: int = 5) -> list[str]:
        """Embed query and retrieve relevant chunks from the glands Qdrant collection."""
