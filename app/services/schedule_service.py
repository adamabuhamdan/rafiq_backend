...
القواعد:
1. التنسيق: الوقت بنظام 24 ساعة بدقة (HH:MM)، الأيام: ["sun","mon","tue","wed","thu","fri","sat"].
...
6. التوقيت الدقيق (AM/PM الصارم): تجنب الخلط بين الصباح والمساء إطلاقاً! جرعات "الصباح" يجب أن تكون بين 05:00 و 11:59. جرعات "المساء" يجب أن تكون بين 17:00 و 23:59.
"""
    if is_primary:
        base += "\n7. الأدوية الأساسية: راعِ أن السكري يحتاج جرعات حول الوجبات (إفطار/عشاء)، والضغط عند الاستيقاظ."
    else:
        base += "\n7. الأدوية الثانوية: وزع الجرعات بالتساوي بعيداً عن أوقات الأدوية الأساسية."
    return base
